...
if(isset($_GET['email']) && isset($_GET['reset_token'])){
    ...
    $date = date("Y-m-d");
    $query = "SELECT * FROM `<table>` WHERE <column> = '$_GET[email]' AND <columna> = '$_GET[reset_token]' AND <column> = '$date' ";
...
if(isset($_POST['updatepassword'])){
    ...
    if(strlen($pass) < 8){
        ...
        $update = "UPDATE `<table>` SET <column> = '$hash', <column> = NULL, <column> = NULL WHERE <column> = '$_GET[email]' ";
