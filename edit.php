...
<script>
    ...
    // for (var i = 1; i <= 5; i++) {
    //     var checkbox = document.getElementById("contactCheckbox" + i);
    //     if (checkbox.checked) {
    //         checked = true;
    //         break;
    //     }
...
<!--<form id="myForm" action="handle_edit.php" method="POST" enctype="multipart/form-data">
    <div class="modal-body">
        <input type="hidden" name="id" id="id" value="<?php echo $id;?>">
        <div class="form-group">
            <label for="text">Username</label>
        ...
        <div class="from-group">
            <label>
                <input type="checkbox" id="contactCheckbox1" onchange="toggleInputField(1)">
                <span>Contact Icon 1</span>
                <input type="text" id="contactURL1" placeholder="Enter URL" style="display: none" name="url1" required><br>
            </label>
        </div>
