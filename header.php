<?php
    ...
    elseif($router == '/logout' || $router == '/logout?i=1'){
        require('logout.php');
    } 
...
echo'
    ...
    <a class="navbar-brand" href="https://dj.000.pe/talksta/">TalkSta</a>
    ...
    if(isset($_SESSION['loggedin']) && $_SESSION['loggedin']== true){
      ...
      echo'
      <div class="row m-2">
      <form class="form-inline my-2 my-lg-0" method="GET" action="https://talksta.000.pe/talksta/search.php">
      ...
      if(isset($_SESSION['loggedin']) && $_SESSION['loggedin']== true){
          echo'
            <form style="display:flex;">
              <p class="text-light my-1 ml-1"><a style="text-decoration: none; color:white;" href="https://talksta.000.pe/talksta/profiles">Welcome '. $_SESSION['user_name'].'</a></p>
              <a href="https://talksta.000.pe/talksta/logout.php" class="btn btn-outline-success ml-2" >Logout</a>
            </form>
          ';
      }
      else{
